...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/04/02 15:03:44 by ygokol            #+#    #+#             */
/*   Updated: 2017/04/02 15:08:13 by ygokol           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_putcolor("eoc");
	ft_putstr("\nYou can also use text decoration, that was pretty swag\n");
	ft_putcolor("bold");
	ft_putstr("bold ");
	ft_putcolor("eoc");
...
void	usage(void)
{
	...
	ft_putstr("Everything as in printf dude, exept of:\n");
